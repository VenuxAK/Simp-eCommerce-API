...
Route::post('/customer/login', [App\Modules\Customer\Http\Controllers\CustomerAuthController::class, 'login'])->middleware('throttle:10,1');

// Customer-authenticated routes (Sanctum with Customer guard).
...
// Staff-authenticated routes (dashboard access).
